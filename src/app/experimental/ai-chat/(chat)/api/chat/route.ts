...
import { systemPrompt } from "~/domains/ai-chat/lib/ai/prompts"
import {
    deleteChatById,
    getChatById,
    getDocumentById,
...
import { generateUUID, getMostRecentUserMessage, sanitizeResponseMessages } from "~/domains/ai-chat/lib/utils"
...
export async function POST(request: Request) {
    const { id, messages, modelId } = (await request.json()) as { id: string; messages: Array<Message>; modelId: string }
