...
import { type UserId } from "~/types/cody"

const profilerLoader = cache(getUserProfileUseCase)

export async function Header() {
    console.log("Getting current user on header")
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger>
                <Suspense
                    fallback={
                        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gray-800">..</div>
                    }
                >
